        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {flatPosts.map((post) => (
            <Link 
              key={post.slug}
              to={post.href}
              className="group relative overflow-hidden rounded-lg border-2 px-5 hover:border-black dark:hover:border-white transition-colors bg-white dark:bg-black hover:shadow-lg dark:hover:shadow-gray-900 no-underline dark-transition"
            >
